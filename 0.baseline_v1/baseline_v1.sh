...
LOG_FILE=${LOG_FILE:-/vllm-workspace/deploy/baseline_v1/baseline_v1.log}
...
echo "=== Baseline :8001 (NPU 10,11, max_num_seqs=${MAX_NUM_SEQS}, max_model_len=${MAX_MODEL_LEN}, max_num_batched_tokens=${MAX_NUM_BATCHED_TOKENS}==="
...
nohup python3 -m vllm.entrypoints.openai.api_server \
    ...
    --enforce-eager --tensor-parallel-size 2 --port 8001 \
    > "$LOG_FILE" 2>&1 &
SERVER_PID=$!
