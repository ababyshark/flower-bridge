...
# Qwen3-30B-A3B, NPU 6,7, port 8013
# activate: VLLM_ASCEND_ENABLE_TQ4_GQA=1
# design: TQ4_GQA_DESIGN.md §7
# =============================================
...
LOG_FILE="${SCRIPT_DIR}/tq4_vllm_$(date +%Y%m%d_%H%M%S).log"
...
echo "============================================"
echo " TQ4 GQA 30B (turboquant-vllm-npu plugin)"
echo "============================================"
echo "  Model:            ${MODEL}"
echo "  Port:             8013"
echo "  TP:               2"
echo "  NPU devices:      6,7"
